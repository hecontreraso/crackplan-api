...
# Public profiles
User.create(privacy: "public", name: "Esteban Contreras", gender: "Male", birthdate: Date.new(1991, 11, 26), email: "hecontreraso@gmail.com", password: "12345678")
User.create(privacy: "public", name: "Morcio D'Achiardi",  gender: "Male", birthdate: Date.new(1992, 6, 26), email: "morcio@morcio.com", password: "12345678")
User.create(privacy: "public", name: "Isabel Ruiz", gender: "Female", birthdate: Date.new(1993, 12, 2), email: "iris9112@gmail.com", password: "12345678")
User.create(privacy: "public", name: "Andres Heredia", gender: "Male", birthdate: Date.new(1996, 11, 2), email: "andres.heredia@gmail.com", password: "12345678")
User.create(privacy: "public", name: "Kung Fury", gender: "Male", birthdate: Date.new(1996, 11, 2), email: "kung.fury@gmail.com", password: "12345678")

# Private profiles
User.create(privacy: "private", name: "Tony Stark", gender: "Male", birthdate: Date.new(1984, 06, 16), email: "tony.stark@avengers.com", password: "12345678")
User.create(privacy: "private", name: "Captain América", gender: "Male", birthdate: Date.new(1912, 2, 3), email: "captain.america@avengers.com", password: "12345678")
User.create(privacy: "private", name: "Bruce Banner", gender: "Male", birthdate: Date.new(1980, 8, 26), email: "hulk@avengers.com", password: "12345678")
User.create(privacy: "private", name: "Thor Odinson", gender: "Male", birthdate: Date.new(1978, 3, 17), email: "thor@avengers.com", password: "12345678")
User.create(privacy: "private", name: "Natasha Romanoff", gender: "Female", birthdate: Date.new(1928, 8, 28), email: "black.widow@avengers.com", password: "12345678")
